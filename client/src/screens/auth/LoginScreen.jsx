      ...
      <div className="flex flex-col w-full min-h-screen relative items-center justify-center py-8 px-4 sm:px-6 overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[530px] rounded-3xl p-8 sm:p-10 bg-white/80 backdrop-blur-2xl shadow-[0_24px_60px_-15px_rgba(184,0,53,0.14),0_10px_25px_-5px_rgba(13,28,47,0.06)] border border-[#e11d48]/20 transition-all duration-300 hover:shadow-[0_30px_70px_-12px_rgba(184,0,53,0.22),0_12px_30px_-5px_rgba(13,28,47,0.08)] ring-1 ring-white/60">
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
            ...
            {/* Federated Institutional SSO Options */}
            <div className="grid grid-cols-3 gap-3">
              <button
                aria-label="Sign in with Google"
                title="Google"
                className="py-2.5 rounded-xl bg-white/80 hover:bg-white border border-outline-variant/40 hover:border-primary/30 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_14px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center transition-all cursor-pointer group"
                type="button"
                onClick={() => setServerError('Institutional Google Workspace SSO is managed by BAUST IT Department. Please use ID & Password.')}
              >
              ...
              <button
                ...
                className="py-2.5 rounded-xl bg-white/80 hover:bg-white border border-outline-variant/40 hover:border-primary/30 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_14px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center transition-all cursor-pointer group"
                type="button"
                onClick={() => setServerError('Facebook login is reserved for external alumni. Please use Institutional ID.')}
              >
                <svg className="w-5 h-5 shrink-0 fill-[#1877F2] transition-transform group-hover:scale-110" viewBox="0 0 24 24">
              ...
              <button
                ...
                className="py-2.5 rounded-xl bg-white/80 hover:bg-white border border-outline-variant/40 hover:border-primary/30 shadow-[0_2px_8px_rgba(0,0,0,0.04)] hover:shadow-[0_4px_14px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 active:translate-y-0 flex items-center justify-center transition-all cursor-pointer group"
                type="button"
                onClick={() => setServerError('Developer GitHub OAuth is enabled for CSE faculty. Please use Institutional ID.')}
              >
                <svg className="w-5 h-5 shrink-0 fill-[#0d1c2f] transition-transform group-hover:scale-110" viewBox="0 0 24 24">
